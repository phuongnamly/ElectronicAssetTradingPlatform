...
//    }
    ...
    void TestGetListingFromGetListing() throws ListingException {
        Listing listing_set = new Listing("1","2","3","4",true,"digital trade","100", "50000","6 June");
        listingdata.create(listing_set);
        ArrayList<Listing> listing_get = listingdata.get("1");
        assertEquals(listing_set.toString(), listing_get.get(0).toString());
    }

    //    Test create Listing
    @Test
    void TestBooleanCreateListing() throws ListingException {
        assertTrue(listingdata.create(new Listing("1","2","3","4",true,"digital trade","100", "50000","6 June")));
    }
    ...
    void TestBooleanListingFromEditListing() throws ListingException{
        listingdata.create(new Listing("1","2","3","4",true,"digital trade","100", "50000","6 June"));
        assertTrue(listingdata.edit(new Listing("1",null,"3", null ,false,"bit coin","100", "50000","7 June")));
    }

    @Test
    void TestGetListingFromEditListing() throws ListingException {
        Listing listing_set_orig = new Listing("1","2","3","4",true,"digital trade","100", "50000","6 June");
        Listing listing_set_new = new Listing("1",null,"3", null ,false,"bit coin","100", "50000","7 June");
        Listing listing_expect = new Listing("1","2","3", "4" ,false,"bit coin","100", "50000","7 June");
        listingdata.create(listing_set_orig);
        listingdata.edit(listing_set_new);
        ArrayList<Listing> listing_get = listingdata.get("1");

        assertEquals(listing_get.get(0).toString(),listing_expect.toString());
    }

    //    Test delete listing
    @Test
    void TestBooleanListingFromDeleteListing() throws ListingException{
        listingdata.create(new Listing("1",null,"3", null ,false,"bit coin","100", "50000","7 June"));
